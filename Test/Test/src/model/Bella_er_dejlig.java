...
public class Bella_er_dejlig {
	...
	public static void main(String[] args) {
		...
		Person Bella = new Person("Bella", 22, "BellaErSødVej 12");
		Person Losse = new Person("Losse", 4, "BellaErSødVej 12");

		System.out.println("Hvor bor Bella og Losse?");
		System.out.println("De bor på " + Bella.getAddress());
	}
}
