...
public class Service {
	...
	public static void initStorage() {
		...
		Excursion r1 = Service.createExcursion("Egeskov Castle", LocalDate.of(2015, 11, 19), 75, c1);
		Excursion r2 = Service.createExcursion("Traphholt Museum", LocalDate.of(2015, 11, 20), 200, c1);

		Participant p1 = Service.createParticipant("Finn Madson", "Silkeborgvej 30", "Aarhus", "Denmark", "1234 5678");
		Participant p2 = Service.createParticipant("Niels Petersen", "Violvej 45", "Copenhagen", "Denmark",
				"9678 9457");
		Participant p3 = Service.createParticipant("Peter Somer", "Thorsgade 2", "Odense", "Denmark", "1678 9098");
		Participant p4 = Service.createParticipant("Lone Jensen", "Nytorv 13", "Aalbrg", "Denmark", "3678 9879");
		...
		Enrollment e1 = Service.createEnrollment(LocalDate.of(2015, 11, 18), LocalDate.of(2015, 11, 20), false, p1, c1,
				null);
		Enrollment e2 = Service.createEnrollment(LocalDate.of(2015, 11, 18), LocalDate.of(2015, 11, 20), false, p2, c1,
				h1);
		Enrollment e3 = Service.createEnrollment(LocalDate.of(2015, 11, 18), LocalDate.of(2015, 11, 19), false, p3, c1,
				h1);
		Enrollment e4 = Service.createEnrollment(LocalDate.of(2015, 11, 18), LocalDate.of(2015, 11, 20), true, p4, c1,
				h1);
