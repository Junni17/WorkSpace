...
public class EnrollmentAdministration extends Stage {
	...
	private class Controller {
		...
		private void okAction() {
			Participant participant = EnrollmentAdministration.this.cmbParticipant.getSelectionModel()
					.getSelectedItem();
			...
			Hotel hotel = EnrollmentAdministration.this.cmbHotel.getSelectionModel().getSelectedItem();
