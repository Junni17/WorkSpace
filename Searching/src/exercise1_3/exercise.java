...
public class exercise {
	...
	public static void main(String[] args) {
		...
		int[] adjacent3 = { 7, 9, 13, 13, 13, 13, 9, 7 };
		...
		System.out.println("Exercise 3: Does a number have one adjacent duplicate in noAdjacent: "
				+ exercise.adjacentAmount(noAdjacent, 1));
		System.out.println("Exercise 3: Does a number have 3 adjacent duplicates in adjacent3: "
				+ exercise.adjacentAmount(adjacent3, 3));
	...
	/**
	 * Exercise 3 <br/>
	 * Returns true if the same number exists in n adjacent places <br/>
	 * Note: n = 1 means we're looking a number with one adjacent duplicate
	 */
