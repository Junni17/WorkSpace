...
public class EnrollmentAdministration extends Stage {
	...
	private TextField conferenceName, companionName, totalPrice;
	...
	private void initContent(GridPane pane) {
		...
		pane.add(lblTotalPrice, 0, 10);

		this.totalPrice = new TextField();
		pane.add(this.totalPrice, 1, 10);
		this.totalPrice.setEditable(false);

		this.lblError = new Label();
		pane.add(this.lblError, 1, 11);

		HBox btnBox = new HBox();
		btnBox.getChildren().add(btnOK);
		btnBox.getChildren().add(btnCancel);
		btnBox.setSpacing(15);
		pane.add(btnBox, 1, 12);
