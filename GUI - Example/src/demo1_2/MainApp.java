...
public class MainApp extends Application
{
    ...
    private void initContent(GridPane pane)
    {
        ...
        // add a text field to the pane (at col=1, row=0, spanning 2 columns and 1 row)
        this.txfName = new TextField();
        pane.add(this.txfName, 1, 0, 2, 1);
    ...
    private void upperCaseAction()
    {
        ...
        this.txfName.setText(name.toUpperCase());
    }

    private void lowerCaseAction()
    {
        String name = this.txfName.getText().trim();
        this.txfName.setText(name.toLowerCase());
    }
}
