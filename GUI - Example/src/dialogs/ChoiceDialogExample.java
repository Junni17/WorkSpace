...
public class ChoiceDialogExample extends Application
{
    ...
    private void initContent(GridPane pane)
    {
        ...
        btnGetChoice.setOnAction(event -> this.getChoiceAction());

        // status text
        this.txtStatus = new Text("Selection: None");
    ...
    private void getChoiceAction()
    {
        ...
        this.txtStatus.setText("Selection: " + selected);
    }
